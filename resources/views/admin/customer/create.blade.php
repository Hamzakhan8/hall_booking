                                        ...
                                        <div class="card-shadow-body">
                                            <form>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control form-dark" name="full_name" placeholder="Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input type="password" class="form-control form-dark" name="password" placeholder="phone number">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control form-dark" name="mobile" placeholder="mobile">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="submit" class="btn btn-primary btn-rounded">Add Customer</button>
                                                    </div>
